    ...
    resources: {
      es: {
        translations: {
          ...
          formHelperDate:
            "Introduce la fecha a la que quieres asignar el precio de la acción",
          formHelperPrice:
      ...
      en: {
        translations: {
          ...
          formHelperDate:
            "Enter the date to which you want to assign the stock price",
          formHelperPrice:
            "Enter the stock price on that date, use . as a decimal separator if necessary",
        },
      },
    },
    fallbackLng: "en",
